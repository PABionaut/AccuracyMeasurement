...
# Define a class to handle the interactive rectangle and centroid calculation
class RectangleSelector:
    ...
    def on_select(self, eclick, erelease):
        ...
        # Calculate the centroid of the region within the rectangle
        ...
        # Draw line and calculate distance if two centroids are marked
...
for i in range(0, sh.nrows):
    ...
    img_path = r'C:\Users\pa480\OneDrive\Documents\GitHub\AccuracyMeasurement\IMAGES\CALIBRATION\{}'.format(fname)
    ...
    threshold = 150  # Define your own threshold here, range is 0 to 255
    ...
    bw_custom_threshold_img_path = r'C:\Users\pa480\OneDrive\Documents\GitHub\AccuracyMeasurement\IMAGES\CALIBRATION\{}_BW.jpg'.format(sh.cell_value(i,0))
    ...
    # Load the uploaded image
    img_path = r'C:\Users\pa480\OneDrive\Documents\GitHub\AccuracyMeasurement\IMAGES\CALIBRATION\{}_BW.jpg'.format(sh.cell_value(i,0))
